...
#from torchlight import torchlight # ran into this error: ImportError: cannot import name 'torchlight' from 'torchlight'
#from .. import torchlight
import sys
import os
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../../torchlight')))
from torchlight import io as torchlight # ugh the torchlight/torchlight folder has io.py and gpu.py
